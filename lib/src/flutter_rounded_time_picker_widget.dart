...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  void _handleHourSelected() {
    setState(() {
      _mode = _TimePickerMode.hour; //_TimePickerMode.minute;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = FlutterRoundedButtonAction(
      ...
      textStyleButtonPositive: TextStyle(color: Color(0xFF3DDC97)),
      textStyleButtonNegative: TextStyle(color: Color(0xFF3DDC97)),
